...
# Define variables
JDK_X64_URL="https://github.com/dub1t0/ubuntu-2204-jdk-6/raw/main/jdk-6u45-linux-x64.bin"
JDK_X32_URL="https://github.com/dub1t0/ubuntu-2204-jdk-6/raw/main/jdk-6u45-linux-i586.bin"
...
ARCH=$(uname -m)
if [ "$ARCH" == "x86_64" ]; then
    JDK_VERSION="jdk-6u45-linux-x64.bin"
    JDK_URL="$JDK_X64_URL"
else
    JDK_VERSION="jdk-6u45-linux-i586.bin"
    JDK_URL="$JDK_X32_URL"
fi
